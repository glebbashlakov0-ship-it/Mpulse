...
export function getConfig(): AppConfig {
  ...
  return {
    ...
    emailFromAddress: stringFromEnv("EMAIL_FROM_ADDRESS") ?? "Market Pulse <noreply@marketpulse.app>",
    appBaseUrl: urlFromEnv("APP_BASE_URL", nodeEnv === "production" ? "https://marketpulse.app" : "http://localhost:5173"),
    cacheTtlMs: {
