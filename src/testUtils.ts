...
export function testConfig(overrides: Partial<AppConfig> = {}): AppConfig {
  return {
    ...
    coinDepositCreditsEnabled: false,
    coinWithdrawalRequestsEnabled: false,
    ...
    moneyOutboxBatchSize: 50,
    moneyOutboxConcurrency: 5,
    moneyOutboxLeaseDurationMs: 120_000,
    moneyOutboxMaxAttempts: 10,
    moneyOutboxBackoffBaseMs: 1_000,
    moneyOutboxBackoffMaxMs: 15 * 60_000,
    moneyOutboxBackoffJitterRatio: 0.2,
    cacheTtlMs: {
      activeMarkets: 1000,
      closedMarkets: 1000,
      marketDetail: 1000,
